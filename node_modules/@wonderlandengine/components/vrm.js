...
WL.registerComponent('vrm', {
    ...
    _parseHumanoid: function(humanoid, extensions) {
        for(const boneName in humanoid.humanBones) {
            ...
            this.bones[boneName] = WL._wrapObject(objectId);
    ...
    _parseFirstPerson: function(firstPerson, extensions) {
        for(const meshAnnotation of firstPerson.meshAnnotations) {
            const annotation ={
                node: WL._wrapObject(extensions.idMapping[meshAnnotation.node]),
                firstPerson: true,
                thirdPerson: true,
            };
    ...
    _findAndParseNodeConstraints: function(extensions) {
        const traverse = (object) => {
            ...
            if(nodeExtensions && "VRMC_node_constraint" in nodeExtensions) {
                ...
                if(type) {
                    const source = WL._wrapObject(extensions.idMapping[constraint[type].source]);
    ...
    _parseAndInitializeSpringBones: function(springBone, extensions) {
        const colliders = (springBone.colliders || []).map((collider, i) => {
            ...
            return {
                id: i,
                object: WL._wrapObject(extensions.idMapping[collider.node]),
                shape: {
        ...
        for(const spring of springBone.springs) {
            ...
            for(const joint of spring.joints) {
                ...
                springJoint.node = WL._wrapObject(extensions.idMapping[springJoint.node]);
            ...
            this._springChains.push({
                name: spring.name,
                center: spring.center ? WL._wrapObject(extensions.idMapping[spring.center]) : null,
                joints,
